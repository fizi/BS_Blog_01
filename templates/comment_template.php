  ...
  <div class="row">
    ...
    <div class="col-sm-10">
	    <div class="row top-row">				
		    <div class="col-md-6 row-grid-1">
          <div class="comment-username">{USERNAME}</div>
          <div class="comment-timedate">{TIMEDATE=relative}</div>
        </div>
		    <div class="col-md-6 row-grid-2 text-right">{REPLY}</div>
	    </div>	
	    <div class="row center-row">
		    <div class="col-md-12 comment-text" id="{COMMENT_ITEMID}-edit" contentEditable="false">
