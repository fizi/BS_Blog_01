...
$NEXTPREV_TEMPLATE['bootstrap_nav_first'] = '<li><a class="hidden-xs" href="{url}" title="{url_label}"><i class="fa fa-angle-double-left"></i></a></li>';
    
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] = '<li><a href="{url}" title="{url_label}"><i class="fa fa-angle-left"></i></a></li>';
    
$NEXTPREV_TEMPLATE['bootstrap_nav_last'] = '<li><a class="hidden-xs" href="{url}" title="{url_label}"><i class="fa fa-angle-double-right"></i></li>';
    
$NEXTPREV_TEMPLATE['bootstrap_nav_next'] = '<li><a href="{url}" title="{url_label}"><i class="fa fa-angle-right"></i></a></li>';
